  ...
  return (
    <section className="py-12 px-2">
      <div className="flex flex-col mx-auto max-w-screen-lg text-center gap-y-12">
        <div>
        <Typography variant="h5" color="blue-gray" className="mt-8 mb-6 font-inter">
        Entdecken Sie ganzheitliche Heilung für Körper und Geist
        </Typography>

        <Typography className="my-10 font-normal !text-gray-500 font-inter">
        Der Alltag kann an den Kräften zehren und sowohl körperliche als auch emotionale Beschwerden verursachen. Unsere Craniosacrale Körperarbeit bietet eine sanfte, aber äußerst wirkungsvolle Methode zur Linderung von Blockaden im Körper und zur Wiederherstellung der inneren Balance.
        </Typography>
        </div>
        
        <div>
        <Typography variant="lead" color="blue-gray" className="mt-8 mb-6 font-inter">
        Wie kann Ihnen die Craniosacrale Körperarbeit helfen?
        </Typography>

        <Typography className="my-12 px-20 font-normal text-gray-500 font-inter">
        <ul>
        ...
        <Typography className="my-12 font-normal !text-gray-500 font-inter">
        <ul>
            <li><strong>Sanfte Methode:</strong> Effektive Linderung durch behutsame Berührungen.</li>
            <li><strong>Ganzheitlicher Ansatz:</strong> ÄWirkt nicht nur auf physischer Ebene, sondern auch auf emotionale Belastungen.</li>
