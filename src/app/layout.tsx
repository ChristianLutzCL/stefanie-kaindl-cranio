...
export const metadata: Metadata = {
  ...
  description:
    'Craniosacrale Körperarbeit – Sanfte, ganzheitliche Behandlung für Erwachsene, Kinder und Babys. Schmerzlinderung, Stressreduktion und tiefe Entspannung.',
  keywords: [
  ...
  twitter: {
    ...
    title: 'Craniosacrale Körperarbeit | Stefanie Kaindl',
    description:
      'Sanfte, ganzheitliche Behandlung für Erwachsene, Kinder und Babys. Schmerzlinderung, Stressreduktion und tiefe Entspannung.',
