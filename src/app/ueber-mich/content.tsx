...
function Content() {
  return (
    <section className="flex pt-40 h-screen therapeutic-gradient">
      <div className="flex flex-grid justify-between mx-auto max-w-screen-2xl gap-y-12 items-center w-full">
        <div className="h-full md:w-1/2 px-6 md:px-0">
          <Typography variant="h3" className="font-inter text-taupe-800 pb-12">
            Über Mich
          </Typography>
          <Typography className="font-normal text-taupe-700 font-inter pb-6">
        ...
        <div className="h-full w-1/2 invisible md:visible">
          <div className="flex justify-end">
            <div className="w-2/3 rounded-md overflow-hidden warm-shadow">
